      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <form method="post" className="grid grid-cols-1 gap-4 md:grid-cols-3">
            ...
            <InputField id="proj_name" name="name" label="Name" />
            <InputField
              id="proj_description"
              name="description"
              label="Description"
            />
            <InputField id="proj_url" name="url" label="URL" />
            <InputField id="proj_repo_url" name="repoUrl" label="Repo URL" />
            <InputField id="proj_date" name="date" label="Date" type="date" />
            {!model.enableUploads ? (
              <InputField id="proj_image" name="image" label="Image URL" />
            ) : null}
                    ...
                    {editing ? (
                      <>
                        ...
                        >
                          ...
                          />
                          <InputField
                            id={`proj_url_${item.id}`}
                            name="url"
                            label="URL"
                            defaultValue={item.url}
                          />
                          <InputField
                            id={`proj_repo_${item.id}`}
                            name="repoUrl"
                            label="Repo URL"
                            defaultValue={item.repoUrl}
                          />
                          <InputField
                            id={`proj_date_${item.id}`}
                            name="date"
                            label="Date"
                            type="date"
